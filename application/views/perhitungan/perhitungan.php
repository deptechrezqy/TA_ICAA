...
<nav>
    <div class="nav nav-tabs" id="nav-tab" role="tablist">
        <a class="nav-item nav-link active w-50" id="nav-entropy-tab" data-toggle="tab" href="#nav-entropy" role="tab" aria-controls="nav-entropy" aria-selected="true">Metode ENTROPY</a>
        <a class="nav-item nav-link w-50" id="nav-moora-tab" data-toggle="tab" href="#nav-moora" role="tab" aria-controls="nav-moora" aria-selected="false">Metode MOORA</a>
    </div>
</nav>
<div class="tab-content mt-4" id="nav-tabContent">
    <div class="tab-pane fade show active" id="nav-entropy" role="tabpanel" aria-labelledby="nav-entropy-tab">
		...
		<div class="card shadow mb-4">
			<!-- /.card-header -->
			<div class="card-header py-3">
				<h6 class="m-0 font-weight-bold text-danger"><i class="fa fa-table"></i> Perhitungan Dispresi Kriteria (Dj)</h6>
			</div>
		...
		<div class="card shadow mb-4">
			<!-- /.card-header -->
			<div class="card-header py-3">
				<h6 class="m-0 font-weight-bold text-danger"><i class="fa fa-table"></i> Normalisasi Nilai Dispersi (Wj)</h6>
			</div>
