...
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
        <div class="d-sm-flex align-items-center justify-content-between">
			<h6 class="m-0 font-weight-bold text-danger"><i class="fa fa-table"></i> <?= $key->keterangan." (".$key->kode_kriteria.")" ?></h6>
				...
				<?= form_open('Sub_kriteria/store') ?>
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<input autocomplete="off" type="number" step="0.001" id="nilai" name="nilai" class="form-control" required>
						</div>
					</div>
							...
							<div class="modal-content">
								...
								<?= form_open('Sub_kriteria/update/'.$key['id_sub_kriteria']) ?>
									...
									<div class="modal-body">
										...
										<div class="form-group">
											<label for="nilai" class="font-weight-bold">Nilai</label>
											<input type="number" step="0.001" autocomplete="off" id="nilai" name="nilai" class="form-control" value="<?= $key['nilai'] ?>" required>
										</div>
									</div>
									<div class="modal-footer">
										<button type="button" class="btn btn-warning" data-dismiss="modal"><i class="fa fa-times"></i> Batal</button>
